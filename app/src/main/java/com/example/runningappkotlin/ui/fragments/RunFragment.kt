...
import com.example.runningappkotlin.adapter.RunAdapter
import com.example.runningappkotlin.other.Constants.REQUEST_CODE_LOCATION_PERMISSION
import com.example.runningappkotlin.other.SortType
    ...
    private fun requestPermissions () {
        ...
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.Q) {
            EasyPermissions.requestPermissions(
                this,
                "You neeed to accept location permission to use this app",
